            ...
            <div className="flex flex-col pt-36 pb-24 gap-y-24 font-inter">
              ...
              <SearchBar />
                <div className="grid grid-cols-3 gap-x-12 gap-y-12">
                  {collections.map((ex, idx) => (
                    <div
                      key={ex.collection_name}
                      className="flex flex-col gap-y-4 border-[1px] border-stone-300 transition-all ease-in-out duration-300 h-full"
                    >
                      <div className="h-56">
                        <img
                      ...
                      <div className="p-6 flex flex-col gap-y-4">
                        ...
                        <p className=" line-clamp-5 ">{ex.collection_description}</p>
                      </div>
                    </div>
                  ))}
                </div>
