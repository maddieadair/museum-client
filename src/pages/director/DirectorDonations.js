...
export default function DirectorDonations() {
            ...
            {donations.length > 0 ? (
              <div className="bg-white rounded-3xl h-fit flex flex-col divide-y-2 divide-slate-100 border">
                <div className="flex flex-row gap-x-6 font-bold p-6 items-center justify-center bg-[#f4f4f4] rounded-t-3xl">
                  ...
                  <p className="w-1/5 ">Donation ID</p>
                  <p className="w-1/5 ">Donor ID</p>
                  <p className="w-1/5 ">Amount</p>
                  <p className="w-1/5 ">Note</p>
                ...
                {donations.map((item, id) => (
                  ...
                  >
                    ...
                    <p className="w-1/5 ">{item.Donation_ID}</p>
                    <p className="w-1/5 ">{item.Donor_ID}</p>
                    <p className="w-1/5 ">${item.Amount_Donated}</p>
                    <p className="w-1/5 line-clamp-2">{item.Donation_Note}</p>
          ...
          <div className="bg-white rounded-3xl h-fit w-1/2 shadow-md flex flex-col">
            <div className="flex flex-col">
              ...
              <div className="flex flex-col divide-y-2 divide-slate-100 px-6 pb-6">
                ...
                <div className="flex flex-row justify-between items-center p-4">
                  <p className="font-bold w-1/2">Donor ID</p>
                  <p className="w-1/2 text-end">{currInput.Donor_ID}</p>
                </div>
                <div className="flex flex-row justify-between items-center p-4">
                  <p className="font-bold w-1/2">Name</p>
                  <p className="w-1/2 text-end">{currInput.Customer_Fname} {currInput.Customer_Lname}</p>
                </div>
                <div className="flex flex-row justify-between items-center p-4">
