...
export default function ExhibitionsFuture() {
          ...
          <div className="flex flex-col gap-y-16 border-b px-16 pb-12">
            <div className="flex flex-col gap-y-4">
              ...
              <p className="text-xl">
                ...
                housing permanent collections of art from every era of history
                and all seven continents, plus special exhibitions.
              </p>
            </div>
